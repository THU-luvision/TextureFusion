...
bool RayIntersectsAABB(const Vec3& start, const Vec3& end, const Point3& lb,
                       const Point3& rt) {
  ...
  // maximal corner start is origin of ray
...
void Raycast(const Vec3& start, const Vec3& end, const Point3& min,
             const Point3& max, Point3List* output) {
  assert(!!output);
