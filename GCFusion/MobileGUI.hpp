...
class MobileGUI
{
  public:
    MobileGUI(int showCaseMode)
    {
        ...
        pangolin::CreateWindowAndBind("FlashFusion", width, height, windowParams);
...
//        icpWeight = new pangolin::Var<float>("ui.ICP weight", 10.0, 0.0, 100.0);
        ...
        drawColors = new pangolin::Var<bool>("ui.Draw tsdf colors", false, true);
//      drawFxaa = new pangolin::Var<bool>("ui.Draw FXAA", showcaseMode, true);
        drawOrigin = new pangolin::Var<bool>("ui.Draw original texture", true, true);
        drawPoints = new pangolin::Var<bool>("ui.Draw modified texture", true, true);
